                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea class="textarea" id="descricao" name="descricao" placeholder="Insira uma descrição" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo @$result->descricao; ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><label for="email" class="control-label">Exibir categoria no site<span class="required"></span></label></td>
                                            <td><INPUT TYPE="checkbox" <?php if($result->exibir == 1){echo 'checked="checked"';}?> NAME="exibirNoSite" VALUE="1"></td>
                                        </tr>
                                    </tbody>
                                </table>
