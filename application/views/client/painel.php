                  ...
                  <tbody>
                      ...
                      if($os != null){
                          foreach ($os as $o) {
                              ...
                              echo '<td>'.$o->status.'</td>';
                              echo '<td> <a href="'.base_url().'index.php/client/visualizarOs/'.$o->idOs.'" class="btn"> <i class="icon-eye-open" ></i> </a></td>';
                              echo '</tr>';
                          }
                      }
                      else{
                  ...
                  <tbody>
                      ...
                      if($compras != null){
                          foreach ($compras as $p) {
                              ...
                              echo '<td>'.$p->nome.'</td>';
                              echo '<td>'.$faturado.'</td>';
                              echo '<td> <a href="'.base_url().'index.php/client/visualizarCompra/'.$p->idVendas.'" class="btn"> <i class="icon-eye-open" ></i> </a></td>';
                              echo '</tr>';
                          }
                      }
                      else{
