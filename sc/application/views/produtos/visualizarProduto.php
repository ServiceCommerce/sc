                            ...
                            <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" id="nome"  name="nome" value="<?php echo @$result['nome']; ?>" disabled /></td>
                                    </tr>
                                    <tr>
                                        <td><label for="email" class="control-label">Unidade<span class="required"></span></label></td>
                                        <td><input class="form-control" id="unidade" type="text" name="unidade" value="<?php echo @$result['unidade']; ?>" disabled /></td>
                                    </tr>
                                    <tr>
                                        <td><label for="senha" class="control-label">Preço Compra<span class="required"></span></label></td>
                                        <td><input class="form-control" id="precoCompra" type="text" name="precoCompra" value="<?php echo @$result['precoCompra']; ?>" disabled /></td>
                                    </tr>
                                    <tr>
                                        <td><label for="telefone" class="control-label">Preço Vanda<span class="required"></span></label></td>
                                        <td><input class="form-control" id="precoVenda" type="text" name="precoVenda" value="<?php echo @$result['precoVenda']; ?>" disabled /></td>
                                        <td><INPUT TYPE="checkbox" NAME="aPartir" VALUE="1" disabled> A Parpir De:</td>
                                    </tr>
                                    <tr>
                                        <td><label for="celular" class="control-label">Estoque</label></td>
                                        <td><input class="form-control" id="estoque" type="text" name="estoque" value="<?php echo @$result['estoque']; ?>" disabled /></td>
                                        <td><INPUT TYPE="checkbox" NAME="semEstoque" VALUE="1" disabled> Produto Sem Estoque</td>
                                    </tr>
                                    <tr>
                                        <td><label for="celular" class="control-label" disabled >Estoque Mínimo</label></td>
                                        <td><input class="form-control" id="estoqueMinimo" type="text" name="estoqueMinimo" value="<?php echo @$result['estoqueMinimo']; ?>" disabled /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="categoria" id="categoria">
                                                <option name="categoria" value=""><?php echo $categoria->nome; ?></option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label for="celular" class="control-label">Divulgação</label></td>
                                        <td><INPUT TYPE="checkbox" <?php echo @$exibir_site ?> NAME="exibirNoSite" VALUE="1" disabled> Exibir produto no site</td>
                                    </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <div class="span12">
                                        <div class="span6 offset3">
                                            ...
                                            if($this->permission->checkPermission($this->session->userdata('permissao'),'eProduto')){?>
                                                <a href="<?php echo base_url('index.php/produtos/editar\/').$result['idProdutos'] ?>" class="btn btn-success"><i class="fa fa-edit" ></i>Editar </a>
                                            <?php
                                            }
                                            ?>
                                        </div>
